    ...
    <nav class="top-bar expanded" data-topbar role="navigation">
        <ul class="title-area large-3 medium-4 columns">
            <li class="name">
                ...
                if ($this->request->action != 'workspace') { 
        ...
        <div class="top-bar-section">
            <ul class="right">
                ...
                <?php endif; ?>
                <?php if ($this->request->action !='index'): ?>
			<?php if ($this->request->action !='password'): ?>
				<?php if ($this->request->action !='workspace'): ?>
		...
		<?php if ($this->request->action =='password'): ?>
                ...
                <?php endif; ?>
		<?php if ($this->request->action == 'workspace'): ?>
                    <li><?= $this->Html->link(__('Get Started'), ['controller' => 'Workspaces', 'action' => 'home']) ?></li>
                <?php endif; ?>
                <?php if ($username): ?>
